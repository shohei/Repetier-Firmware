...
//for 6axis
#define ORIG_XX_STEP_PIN        3 
#define ORIG_XX_DIR_PIN         4  
#define ORIG_XX_ENABLE_PIN      41
// #define ORIG_XX_MIN_PIN         -1
#define ORIG_XX_MAX_PIN         5

#define ORIG_YY_STEP_PIN        10
#define ORIG_YY_DIR_PIN         11
#define ORIG_YY_ENABLE_PIN      5
// #define ORIG_YY_MIN_PIN         -1
#define ORIG_YY_MAX_PIN         39

#define ORIG_ZZ_STEP_PIN        43
#define ORIG_ZZ_DIR_PIN         45
#define ORIG_ZZ_ENABLE_PIN      12
// #define ORIG_ZZ_MIN_PIN         -1
#define ORIG_ZZ_MAX_PIN         40
//end 6axis
...
//6axis
#define XX_STEP_PIN ORIG_XX_STEP_PIN
#define XX_DIR_PIN ORIG_XX_DIR_PIN
#define XX_ENABLE_PIN ORIG_XX_ENABLE_PIN
#define XX_MIN_PIN ORIG_XX_MIN_PIN
#define XX_MAX_PIN ORIG_XX_MAX_PIN

#define YY_STEP_PIN ORIG_YY_STEP_PIN
#define YY_DIR_PIN ORIG_YY_DIR_PIN
#define YY_ENABLE_PIN ORIG_YY_ENABLE_PIN
#define YY_MIN_PIN ORIG_YY_MIN_PIN
#define YY_MAX_PIN ORIG_YY_MAX_PIN

#define ZZ_STEP_PIN ORIG_ZZ_STEP_PIN
#define ZZ_DIR_PIN ORIG_ZZ_DIR_PIN
#define ZZ_ENABLE_PIN ORIG_ZZ_ENABLE_PIN
#define ZZ_MIN_PIN ORIG_ZZ_MIN_PIN
#define ZZ_MAX_PIN ORIG_ZZ_MAX_PIN
//end 6axis
...
#define SENSITIVE_PINS {0, 1, ORIG_X_STEP_PIN, ORIG_X_DIR_PIN, ORIG_X_ENABLE_PIN, ORIG_X_MIN_PIN, ORIG_X_MAX_PIN, \
        ORIG_Y_STEP_PIN, ORIG_Y_DIR_PIN, ORIG_Y_ENABLE_PIN, ORIG_Y_MIN_PIN, ORIG_Y_MAX_PIN, ORIG_Z_STEP_PIN,\
        ORIG_Z_DIR_PIN, ORIG_Z_ENABLE_PIN, ORIG_Z_MIN_PIN, ORIG_Z_MAX_PIN, LED_PIN, ORIG_PS_ON_PIN, \
        ORIG_XX_STEP_PIN, ORIG_XX_DIR_PIN, ORIG_XX_ENABLE_PIN, ORIG_XX_MAX_PIN, \
        ORIG_YY_STEP_PIN, ORIG_YY_DIR_PIN, ORIG_YY_ENABLE_PIN, ORIG_YY_MAX_PIN, \
        ORIG_ZZ_STEP_PIN,ORIG_ZZ_DIR_PIN, ORIG_ZZ_ENABLE_PIN, ORIG_ZZ_MAX_PIN,\
       HEATER_0_PIN, HEATER_1_PIN, /*ORIG_FAN_PIN,*/ E0_PINS E1_PINS E2_PINS TEMP_0_PIN, TEMP_1_PIN,SDSS }
#endif
